#!/usr/bin/env python3
"""Gymnasium environment wrapper for Stage R3: Rack Box Pick & Stow."""
...
class RackPickGymEnv(gym.Env):
    """Gymnasium environment wrapping Godot 4 Stage R3 Rack Box Pick & Stow scene."""

    metadata = {"render_modes": ["headless"]}

    def __init__(
        self,
        scene_path: str = "res://scenes/training/training_rack_pick.tscn",
        port: int = 11103,
